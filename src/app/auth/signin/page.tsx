                ...
                <div className="bg-[#161618] backdrop-blur-xl border border-white/10 rounded-[2rem] shadow-2xl p-8 sm:p-10">
                    ...
                    <div className="flex bg-[#1e1e20] p-1.5 rounded-2xl mb-8 border border-white/5">
                        <button
                            ...
                            className={`flex-1 py-2.5 rounded-xl text-xs sm:text-sm font-bold transition-all flex items-center justify-center gap-2 ${signInMethod === "email"
                        ...
                        <button
                            ...
                            className={`flex-1 py-2.5 rounded-xl text-xs sm:text-sm font-bold transition-all flex items-center justify-center gap-2 ${signInMethod === "phone"
