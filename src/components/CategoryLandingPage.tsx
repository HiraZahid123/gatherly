                    ...
                    <div className="flex-1 relative w-full aspect-square md:aspect-video lg:aspect-square max-w-2xl">
                        ...
                        >
                            <div className="w-full h-[60%] bg-gradient-to-br from-[#00E676]/20 to-[#FFB300]/20 relative">
                                <Image src={templates[0]?.image || "/partiful/disco-pride.avif"} alt="Cover" fill className="object-cover opacity-80 mix-blend-overlay" />
                            ...
                            <div className="p-6 text-white absolute bottom-0 w-full bg-[#16181c]/80 backdrop-blur-md">
                                <h3 className="text-2xl font-black mb-1 capitalize">{templates[0]?.label || "VIP Access"}</h3>
                                <p className="text-[#00E676] font-medium text-sm">Thursday, Jul 31</p>
                            </div>
                        </motion.div>
                        ...
                        >
                            <div className="w-full h-[60%] bg-gradient-to-br from-indigo-500/30 to-purple-500/30 relative">
                                <Image src={templates[1]?.image || "/partiful/mocktail-party.avif"} alt="Cover" fill className="object-cover opacity-90 mix-blend-overlay" />
                            ...
                            <div className="p-6 text-white absolute bottom-0 w-full bg-[#1a1c23]/80 backdrop-blur-md">
                                <h3 className="text-2xl font-black mb-1 text-[#FFB300] capitalize">{templates[1]?.label || "Gold Lounge"}</h3>
                                <p className="text-white/70 font-medium text-sm">Friday, Aug 15</p>
                            </div>
                        </motion.div>
                    </div>
